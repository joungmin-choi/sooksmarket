...
app.post('/find/:type', function(req, res){
  ...
  if(type === "id"){
    if(req.body.id != undefined){
      var login_email = req.body.id + '@naver.com';
    ...
    if(req.body.pwd != undefined){
      var login_email = req.body.pwd + '@naver.com';
      var str = 'SELECT * FROM users WHERE login_email=?';
...
//   var str1 = 'SELECT * FROM TradeInfo WHERE seller=? AND state<4';
//   var str2 = 'SELECT * FROM TradeInfo WHERE customer=? AND state<4';
//   var flag = 0;
//
//   async.series([
//     function(callback){
//       client.query(str1, [loginId[1]], function(err, result){
